<template>
  <div class="test">
    ...
    <input class="textarea" type="text" placeholder="Type here!" id="input"/><div class="emojis"></div>
    ...
    export default {
        ...
        methods: {
            ...
            getPost() {
                // eslint-disable-next-line     
                console.log("getPost");
                firebase.database().ref('chatroom').on('value', function(data) {
